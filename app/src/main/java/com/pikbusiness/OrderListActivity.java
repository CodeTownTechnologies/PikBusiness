...
public class OrderListActivity extends AppCompatActivity {
    ...
    RecyclerView inprogress_recyclerView;
    @BindView(R.id.ready)
    RecyclerView ready_recyclerView;
    ...
    private String lname, bname, objectId, shopsts, latitude, longitude, pass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirebaseAnalytics.setCurrentScreen(OrderListActivity.this, "Orderslist", "ss");
...
//                    }else{
//                    testAdapter = new NewOrderAdapter(OrderListActivity.this, neworders_hashmap);
...
//                    }else{
                    testAdapter2 = new InProgressAdapter(OrderListActivity.this, inprogress_hashmap);
...
//                    }else{
                    testAdapter3 = new ReadyAdapter(OrderListActivity.this, reay_hashmap);
...
//                            estimatedData.setRefundCost(user.getNumber("refundCost").doubleValue());
                        ...
                        if (testAdapter != null) {
                            //testAdapter.setData(newOrderList);
                            testAdapter.notifyDataSetChanged();
                        } else {
                            testAdapter = new NewOrderAdapter(OrderListActivity.this, newOrderList);
                            neworders_recyclerView.setAdapter(testAdapter);
                        }

                        txt_neworder.setText("NEW ORDER" + " - " + newOrderList.size());
...
//        System.exit(0);
    ...
    public void updateNewOrderCount(List<Orders> data) {
