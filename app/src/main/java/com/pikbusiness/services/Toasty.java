...
public class Toasty {
    ...
    @ColorInt
    private static int WARNING_COLOR = Color.parseColor("#3F51B5");
    @ColorInt
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
        ...
        if (shouldTint)
            ...
            drawableFrame = ToastyUtils.getDrawable(context, R.drawable.bg_tooltip_blue);
...
//        LOADED_TOAST_TYPEFACE = Typeface.createFromAsset(context.getAssets(), "font/gotham.ttf");
    ...
    public static class Config {
        ...
        public static void reset() {
            ...
            Toasty.WARNING_COLOR = Color.parseColor("#3F51B5");
